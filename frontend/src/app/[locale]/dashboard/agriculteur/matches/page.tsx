...
export default function FarmerMatchesPage() {
  const t = useTranslations('FarmerMatches');
            ...
            {filteredMatches.map((match) => (
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-foreground/60">
                        {t('requestedBy', { name: match.demand.collector.full_name })}
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg">
                    <p className="text-xs text-foreground/60 mb-2">{t('collectorDemand')}</p>
                    <p className="text-sm font-medium text-foreground">
                      {t('demandDetails', { 
                    ...
                    <p className="text-xs text-foreground/60 mt-1">{match.demand.collector.region}</p>
                  </div>
                </div>
